...
for ac in range(len(acc)):
    ...
    plt.savefig(f"./aa_composition_output/{acc[ac]}.pdf",format="pdf",bbox_inches="tight")
    plt.clf()


print(f"Output figures are saved in aa_composition_output folder as their accession_id\nexample: {acc[0]}.pdf")
