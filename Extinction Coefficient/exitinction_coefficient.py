...
with open("./output/Extinction_coefficient.tsv","w") as wh:
    ...
    wh.write("Accession_ID\tECprotCC(M^-1 cm^-1)\tABprotCC(mg/ml)\tConcProtCC(mol/ml)\tECprotC(M^-1 cm^-1)\tABprotC(mg/ml)\tConcProtC(mol/ml)\n")
...
print("The output file is saved in output folder")             
